...
import studyMateSuperPackage.main.Main;
import studyMateSuperPackage.ui.mainView.MainViewController;
import studyMateSuperPackage.main.ReminderService;
...
//    private Circle closePostView;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        closePostView.setOnMouseClicked((ev) -> {
            setPostView(false);
        });
        helper = DatabaseHelper.getInstance();
        initList();
        postsList.setOnMouseClicked((ev) -> {
            openPost(ev);
        });
        setPostView(false);
    ...
    private void openPost(MouseEvent ev) {
        if (ev.getTarget() instanceof GridPane) {
            ...
            timePicker.setValue(LocalTime.of(reminder.get(Calendar.HOUR_OF_DAY), reminder.get(Calendar.MINUTE)));
    ...
    private void addAction(ActionEvent event) {
        ...
        LocalDateTime reminderDaTim = LocalDateTime.of(datePicker.getValue(), timePicker.getValue());
